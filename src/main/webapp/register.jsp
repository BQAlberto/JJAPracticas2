...
<main class="form-signup w-100 m-auto">
    <form>
        ...
        <div class="form-floating p-1">
            <input class="form-control" id="floatingInput" placeholder="firstname">
        ...
        <div class="form-floating p-1">
            <input class="form-control" placeholder="11111111">
        ...
        <div class="mt-3">
            <button class="btn btn-dark w-100 py-2 mb-2" type="submit">Sign up</button>
        </div>
        <div id="result"></div>
    </form>
</main>
